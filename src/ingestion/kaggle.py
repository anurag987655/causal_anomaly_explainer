...
# Configuration
RAW_DATA = "/home/anurag/Projects/NetCausalAI_test/data/raw/Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv"
OUTPUT_FILE = "data/processed/all_sessions_detailed.csv"
SAMPLE_SIZE = 50000  # <--- Change this to 30,000 for lightning speed
...
def transform_kaggle_fast():
    ...
    # Load limited rows
    try:
        df = pd.read_csv(RAW_DATA,nrows=SAMPLE_SIZE)
